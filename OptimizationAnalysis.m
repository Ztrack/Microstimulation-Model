...
x = zeros(200,1)+1/5000;
problem.VarMax =  [threshold.c .*1250 x'];   % Upper Bound of Decision Variables

% problem.VarMin =  zeros(200,1);  % TEST VARIABLES - 0
% problem.VarMax =  ones(200,1); % TEST VARIABLES
