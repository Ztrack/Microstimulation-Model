...
problem.CostFunction = @(x) MotionRatioCombined(x,NumNeurons,I0_Axon_Neurons,I0_Soma_Neurons,Directional_Current_Mult,Neuron_Motion,Neuron_NonMotion,Neuron_Type,Neuron_Excitatory,Neuron_Inhibitory,Neuron_Motif); % Cost
...
%% Functions
function z = MotionRatioCombined(x,NumNeurons,I0_Axon_Neurons,I0_Soma_Neurons,Directional_Current_Mult,Neuron_Motion,Neuron_NonMotion,Neuron_Type,Neuron_Excitatory,Neuron_Inhibitory,Neuron_Motif)
